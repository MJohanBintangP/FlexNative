...
const Author = () => {
  ...
  return (
    <div className="mt-24 mb-24">
      <button className="fixed top-5 left-5 flex items-center text-black font-semibold bg-white px-4 py-2 rounded-lg transition z-50" onClick={() => navigate('/')}>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-24 gap-6 w-full">
        ...
        <div className="text-white flex flex-col gap-8 px-4 sm:px-12 items-end lg:items-end text-right lg:text-right">
          <div>
            <a target="_blank" rel="noreferrer" className="font-bold text-[24px] sm:text-[30px] block" href="https://www.instagram.com/clis3n">
              CLISEN ARDY LAKSONO W
            </a>
            <p className="text-[#CFCFCF] text-[16px] sm:text-[20px]">UIX Designer</p>
          </div>
          <div>
            <a target="_blank" rel="noreferrer" className="font-bold text-[24px] sm:text-[30px] block" href="https://www.instagram.com/kusumaj_ris">
              RISMA KUSUMAJATI
            </a>
            <p className="text-[#CFCFCF] text-[16px] sm:text-[20px]">UIX Designer</p>
          </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-6 w-full">
        <div className="text-white flex flex-col gap-8 px-4 sm:px-12 items-center lg:items-start text-left lg:text-left">
          <div>
            <a target="_blank" rel="noreferrer" className="font-bold text-[24px] sm:text-[30px] block" href="https://www.instagram.com/mjohanbintangp">
        ...
        <div className="w-fulllg:w-1/2 flex flex-col items-end">

...
// Data default untuk course React Native
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/courses')
      .then((res) => {
        ...
        setCourses(mergedCourses.slice(0, 3)); // Ambil 3 course pertama
      })
      .catch(() => setCourses(defaultCourses)); // Fallback ke data lokal
  }, []);
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <div 
              key={course._id}
              className="bg-[#1E1F27] rounded-2xl border border-[#3E3F46] hover:border-blue-500 transition-all duration-300 overflow-hidden group"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center text-sm text-gray-400">
                  ...
                  <button 
                    ...
                    onClick={() => alert(`Memulai course: ${course.title}`)}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

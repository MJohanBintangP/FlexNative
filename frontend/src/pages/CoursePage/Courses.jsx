...
export const defaultCourses = [
  {
    ...
    description:
      "Learn the basics of React Native, including environment setup, core components, and basic styling.",
    image: courseImage1,
    rating: 4.8,
    duration: "6 Hours",
    level: "Beginner",
  },
  {
    ...
    description:
      "Build modern user interfaces with advanced components and animations.",
    image: courseImage2,
    rating: 4.7,
    duration: "8 Hours",
    level: "Intermediate",
  },
  {
    ...
    description:
      "Performance optimization, native module integration, and state management with Redux.",
    image: courseImage3,
    rating: 4.9,
    duration: "10 Hours",
    level: "Advanced",
  },
  {
    ...
    description:
      "Learn different types of navigation like Stack, Tab, and Drawer using React Navigation.",
    image: courseImage4,
    rating: 4.6,
    duration: "5 Hours",
    level: "Intermediate",
  },
  {
    ...
    description:
      "Connect to RESTful APIs, fetch data, and display it securely and efficiently in your app.",
    image: courseImage5,
    rating: 4.7,
    duration: "7 Hours",
    level: "Beginner",
  },
  {
    ...
    description:
      "Prepare your app for production and upload it to the Play Store and App Store.",
    image: courseImage6,
    rating: 4.8,
    duration: "6.5 Hours",
    level: "Advanced",
...
const courseContent = {
  1: [
    ...
    },
    {
      ...
      lessons: [
        ...
        "When to use CLI",
        "Migrating between Expo and CLI"
      ]
    },
    {
  ...
  2: [
    ...
    },
    {
      ...
      duration: "22 minutes",
      lessons: [
        "TextInput and State Usage",
        "Handling onPress Event",
    ...
    },
    {
      ...
      lessons: [
        ...
        "Local vs URL Image Sources",
        "ResizeMode and Image Styling"
      ]
    },
    {
  ...
  3: [
    ...
    },
    {
      ...
      lessons: [
        ...
        "useContext Hook",
        "Example of global state application"
      ]
    }
  ],
  4: [
    ...
    },
    {
      ...
      lessons: [
        ...
        "Retrieving params on the destination screen",
        "Example application: product detail"
      ]
    },
    {
    ...
    },
    {
      ...
      lessons: [
        ...
        "Navigation between navigators",
        "Navigation organization tips"
      ]
    }
  ],
  5: [
    ...
    },
    {
      ...
      duration: "19 minutes",
      lessons: [
        "Creating a form with TextInput",
        "Using useState for input",
        "Sending data to API with POST"
      ]
    },
    {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:5000/api/courses")
      .then((res) => {
        ...
        const uniqueCourses = merged.filter((c, i, self) =>
          self.findIndex(item => item._id === c._id) === i
        );
          ...
          {courseContent[selectedCourse._id]?.map((chapter, index) => (
            <div
              ...
              ${currentChapter === index
                  ? "bg-gradient-to-r from-blue-600/30 to-purple-600/30 border-l-4 border-blue-400 ml-1"
                  : "hover:bg-[#ffffff08] ml-1"}`}
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 h-[2px] bg-[#ffffff10] rounded-full">
                    <div
                      ...
                      style={{ width: `${(index / (courseContent[selectedCourse._id].length - 1)) * 100}%` }}
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="relative bg-gradient-to-br from-[#1E1F27] to-[#2A2B32] rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="px-3 py-1 bg-[#ffffff10] text-gray-300 rounded-full text-sm">
                {courseContent[selectedCourse._id][currentChapter].duration}
              </span>
            </div>
            <h3 className="text-3xl font-bold text-white">
              {courseContent[selectedCourse._id][currentChapter].title}
            </h3>
          </div>
          ...
          <div className="mt-8 space-y-6">
            <div className="bg-gradient-to-r from-[#1E1F27] to-[#2A2B32] p-6 rounded-xl border border-[#ffffff10]">
              ...
              <p className="text-gray-300 leading-relaxed">
                {courseContent[selectedCourse._id][currentChapter].content}
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#1E1F27] to-[#2A2B32] p-6 rounded-xl border border-[#ffffff10]">
              ...
              <ul className="space-y-3">
                {courseContent[selectedCourse._id][currentChapter].lessons.map((lesson, i) => (
                  <li
                    key={i}
                    className="flex items-center gap-3 p-3 bg-[#ffffff05] hover:bg-[#ffffff10] rounded-lg transition-colors"
                  >
        ...
        {!selectedCourse ? (
          <>
            <div className="flex flex-col mb-8">
              ...
              Level up your mobile development skills with a hands-on, industry-ready React Native curriculum!
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.map((course) => (
                <div
                  key={course._id}
                  className="bg-gradient-to-b from-[#1E1F27] to-[#2A2B32] rounded-2xl border border-[#3E3F46] hover:border-blue-500 transition-all duration-300 overflow-hidden group relative"
                >
                  <button
                  ...
                  >
                    <svg
                      className={`w-6 h-6 ${isBookmarked(course._id)
